...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__member_member_details_edit_member_details_edit_component__ = __webpack_require__("./src/app/member/member-details-edit/member-details-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__member_member_details_member_details_component__ = __webpack_require__("./src/app/member/member-details/member-details.component.ts");
...
var routes = [
    { path: 'details', component: __WEBPACK_IMPORTED_MODULE_9__member_member_details_member_details_component__["a" /* MemberDetailsComponent */] },
    { path: 'edit', component: __WEBPACK_IMPORTED_MODULE_8__member_member_details_edit_member_details_edit_component__["a" /* MemberDetailsEditComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__member_member_details_edit_member_details_edit_component__ = __webpack_require__("./src/app/member/member-details-edit/member-details-edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_20__member_member_details_edit_member_details_edit_component__["a" /* MemberDetailsEditComponent */]
            ],
            imports: [
...
/***/ "./src/app/member/member-details-edit/member-details-edit.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/member/member-details-edit/member-details-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container-fluid\">\r\n  <div class=\"card mb-3 col-sm-3\" width=\"250\">\r\n    <img class=\"card-img-top\" src=\"{{member.photoUrl}}\" height=\"140\" width=\"140\" />\r\n    <div class=\"card-body\">\r\n      <h1 class=\"card-title\">{{member.name}}'s Profile</h1>\r\n      <p class=\"card-text\">{{member.city}}, {{member.age}}</p>\r\n      <p class=\"card-text\">Last Active: {{member.lastActive}}</p>\r\n    </div>\r\n  </div>\r\n  <div id=\"description\" class=\"col-sm-9\">\r\n    <h2>More About {{member.name}}</h2>\r\n    <h3>Description: </h3> <br />\r\n    <textarea name=\"Description\" rows=\"50\" cols=\"100\"></textarea>\r\n    <h3>Looking For: </h3><br />\r\n    <textarea name=\"Lookingfor\" rows=\"50\" cols=\"100\"></textarea>\r\n    <h3>Interests: </h3> <br />\r\n    <textarea name=\"interest\" rows=\"50\" cols=\"100\"></textarea>\r\n    <h3>City</h3>\r\n    <input type=\"text\" value=\"{{member.city}}\"/> \r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/member/member-details-edit/member-details-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MemberDetailsEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MemberDetailsEditComponent = /** @class */ (function () {
    function MemberDetailsEditComponent() {
    }
    MemberDetailsEditComponent.prototype.ngOnInit = function () {
    };
    MemberDetailsEditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-member-details-edit',
            template: __webpack_require__("./src/app/member/member-details-edit/member-details-edit.component.html"),
            styles: [__webpack_require__("./src/app/member/member-details-edit/member-details-edit.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], MemberDetailsEditComponent);
    return MemberDetailsEditComponent;
}());
...
module.exports = "<div class=\"container-fluid\">\r\n  <div class=\"card mb-3 col-sm-3\" width=\"250\">\r\n    <img class=\"card-img-top\" src=\"{{member.photoUrl}}\" height=\"140\" width=\"140\" />\r\n    <div class=\"card-body\">\r\n      <h1 class=\"card-title\">{{member.name}}'s Profile</h1>\r\n      <p class=\"card-text\">{{member.city}}, {{member.age}}</p>\r\n      <p class=\"card-text\">Last Active: {{member.lastActive}}</p>\r\n    </div>\r\n  </div>\r\n  <div id=\"description\" class=\"col-sm-9\" >\r\n    <h2>More About {{member.name}}</h2>\r\n    <h3>Description: </h3> <br />\r\n    <p>{{member.introduction}}</p><br />\r\n    <h3>Looking For: </h3><br />\r\n    <p>{{member.lookingFor}}</p><br />\r\n    <h3>Interests: </h3> <br />\r\n    <p>{{member.interests}}</p><br />\r\n    <h3>Photos:</h3><br />\r\n     <li *ngFor=\"let photo of photos\">\r\n       {{ photo.url }}\r\n     </li>\r\n  </div>\r\n</div>\r\n"
